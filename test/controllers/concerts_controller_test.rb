...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { asistentes: @concert.asistentes, duracion: @concert.duracion, fecha: @concert.fecha, group_id: @concert.group_id, lugar: @concert.lugar } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { asistentes: @concert.asistentes, duracion: @concert.duracion, fecha: @concert.fecha, group_id: @concert.group_id, lugar: @concert.lugar } }
